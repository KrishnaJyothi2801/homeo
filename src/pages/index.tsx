  ...
  return (
    <Layout>
      <Head>
        ...
        <link rel="canonical" href="https://drsivashomeo.webaglet.in" />
      </Head>

      <main className="pt-16">
<div
  className="relative flex flex-col lg:flex-row items-center justify-center 
  p-6 pt-16 sm:p-10 sm:pt-16 md:p-16 md:pt-24 lg:p-20 
  bg-cover bg-center bg-no-repeat"
  style={{ backgroundImage: "url('/images/generated-image.png')" }}
>
  {/* Soft Gradient Overlay */}
  <div className="absolute inset-0 bg-gradient-to-r from-white/80 via-blue-100/60 to-white/70" />

  {/* Doctor Image */}
  <img
    src="/images/doctor.jpeg"
    alt="Dr.Siva Multi-speciality Homoeo Care"
    className="relative z-10 w-40 h-52 sm:w-52 sm:h-64 md:w-80 md:h-[26rem] lg:w-96 lg:h-[30rem]
    rounded-full object-cover object-[center_top] mb-6 lg:mb-0 lg:mx-auto 
    shadow-xl border-4 border-[#CAF1FC]"
  />

  {/* Content Card */}
  <div className="relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left p-4 sm:p-8 md:p-10 max-w-3xl mx-auto mt-4 lg:mt-0">

    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold 
    text-[#0b132b] mb-3 tracking-tight">
      Dr. Sivasubramoniam
    </h1>

    <p className="text-lg sm:text-xl md:text-2xl text-[#1c2541] mb-4 font-semibold italic">
      B.Sc; M.D (Homoeo)
    </p>
    ...
    <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-8 leading-relaxed max-w-xl">
